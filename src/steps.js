    ...
    <ChatBot
      ...
      steps={[
        ...
        },
        {
          id: "2",
          message:
            "I've been asked to make sure your system is ready for a BSWH call. Shall we get started?",
          trigger: "3",
        },
        {
          id: "3",
        ...
        },
        {
          id: "4",
          message:
            "Alrighty, let's start by testing your speakers. Click Play!",
          trigger: "6",
        },
        {
          id: "end-message",
        ...
        {
          id: "6",
          options: [{ value: true, label: "Play", trigger: "audio" }],
        },
        {
          id: "audio",
          component: (
        ...
        {
          id: "11",
          options: [{ value: true, label: "Okay!", trigger: "12" }],
        },
        {
          id: "12",
          message:
            "I'll need your permission to use your microphone and webcam. When prompted, click Allow. 🙏",
          trigger: "13",
        },
        {
          id: "13",
        ...
        },
        {
          id: "14",
          message:
            "Ok great, it looks like we can now access your microphone and camera!",
          trigger: "18",
        },
        {
          id: "15",
        ...
        },
        {
          id: "16",
          message:
            "In order for your microphone and webcam to work, you need to allow access.",
          trigger: "17",
        },
        {
          id: "17",
          options: [{ value: true, label: "Try Again!", trigger: "10" }],
        },
        {
          id: "no-devices-message",
          message:
            "Uh oh! Looks like you dont have either camera or microphone connected to your device",
          trigger: "17",
        },
        {
          id: "18",
        ...
        },
        {
          id: "20",
          message:
            "Ok, time for the webcam! Do you see a video feed of yourself?",
          trigger: "video",
        },
        {
          id: "video",
